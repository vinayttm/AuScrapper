...
import com.app.auScrapper.services.RecorderService
import com.app.auscrapper.R
...
class MainActivity : AppCompatActivity() {
    ...
    fun onAppFlowStarted(view: View) {
        ...
        val inActive = Runnable {
            runOnUiThread {
                Toast.makeText(this, "AuScrapper inactive", Toast.LENGTH_LONG).show()
            }
